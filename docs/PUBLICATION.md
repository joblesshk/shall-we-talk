...
The original product license remains proprietary; this is not an open-source relicensing. Private GitHub hosting is not a substitute for reviewing obligations before binary redistribution.
